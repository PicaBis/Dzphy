                  ...
                  <ToastProvider>
                    <BookmarksProvider>
                      <MotionProvider>
                        <a
                          href="#main-content"
                          className="sr-only focus:not-sr-only focus:absolute focus:top-4 focus:right-4 focus:z-[100] focus:bg-orange-500 focus:text-white focus:px-4 focus:py-2 focus:rounded-xl focus:font-bold"
                        >
